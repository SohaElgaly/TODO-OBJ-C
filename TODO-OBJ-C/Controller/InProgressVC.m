...
@property NSMutableArray<Task*> *inProgressDisplayArray;
...
- (void)viewDidLoad {
    ...
    _inProgressDisplayArray = [NSMutableArray<Task*> new];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Task *task = _isSearching ? _filteredTodoArray[indexPath.row] : [self tasksForSection:indexPath.section][indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    Task *selectedTask = _isSearching ? _filteredTodoArray[indexPath.row] : [self tasksForSection:indexPath.section][indexPath.row];
...
- (void)filterTasksForSearchText:(NSString *)searchText {
    ...
    NSArray<Task*> *filtered = [_inProgressDisplayArray filteredArrayUsingPredicate:predicate];
